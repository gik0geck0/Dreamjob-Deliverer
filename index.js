...
var authErrorURL = '/app/admin/error/';
...
admin.get("/oauth/forcedotcom/callback",
    passport.authenticate('forcedotcom', { failureRedirect: '/error' }),
    function(request, response){
        response.render("index",checkSession(request));
    }
);

admin.get("/error", function(request, response) {
...
//admin get method
admin.get('/', passport.authenticate('forcedotcom', { failureRedirect: '/error' }), function(request, response) {
